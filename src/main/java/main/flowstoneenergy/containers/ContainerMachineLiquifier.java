...
import main.flowstoneenergy.tileentities.TileEntityMachineLiquifier;
...
public class ContainerMachineLiquifier extends Container {
	public ContainerMachineLiquifier(EntityPlayer player, TileEntityMachineLiquifier entity) {
