...
public class OreTumblerHandler extends TemplateRecipeHandler {
    class CachedOreTumblerRecipe extends TemplateRecipeHandler.CachedRecipe {

        private ItemStack input1;
        private ItemStack output;

        public CachedOreTumblerRecipe(Recipe1_1 r) {
    ...
    public String getGuiTexture() {
        return ModInfo.MODID + ":textures/guis/oreTumblerGui.png";
    }

    @Override
    public String getRecipeName() {
        return StatCollector.translateToLocal("Energized Ore Tumbler");
    }
