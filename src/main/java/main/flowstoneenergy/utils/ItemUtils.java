...
import main.flowstoneenergy.items.ItemMetaResourceIngots;
...
public class ItemUtils {
    ...
    private static void registerSmeltingRecipes() {
        ...
        GameRegistry.addSmelting(BlockUtils.copperOre, new ItemStack(metaResourceIngot, 1, 0), 0.7F);
        GameRegistry.addSmelting(BlockUtils.tinOre, new ItemStack(metaResourceIngot, 1, 1), 0.7F);
        GameRegistry.addSmelting(BlockUtils.leadOre, new ItemStack(metaResourceIngot, 1, 2), 1.0F);
        GameRegistry.addSmelting(BlockUtils.silverOre, new ItemStack(metaResourceIngot, 1, 3), 1.0F);
    ...
    private static void registerTumblerRecipes() {
        ...
        RecipesEnergizedOreTumbler.AddRecipe(new ItemStack(BlockUtils.copperOre), new ItemStack(metaResourceDust, 2, 3), 200);
        RecipesEnergizedOreTumbler.AddRecipe(new ItemStack(BlockUtils.tinOre), new ItemStack(metaResourceDust, 2, 4), 200);
        RecipesEnergizedOreTumbler.AddRecipe(new ItemStack(BlockUtils.leadOre), new ItemStack(metaResourceDust, 2, 5), 200);
