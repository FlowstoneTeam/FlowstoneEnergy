...
public class FAKEITEM extends Item {
	...
	public void getSubItems(Item item, CreativeTabs tab, List l) {
		...
		l.add(new ItemStack(BlockUtils.copper));
		l.add(new ItemStack(BlockUtils.tin));
		l.add(new ItemStack(BlockUtils.lead));
		l.add(new ItemStack(BlockUtils.silver));
		l.add(new ItemStack(BlockUtils.nickel));
		l.add(new ItemStack(BlockUtils.invar));
		l.add(new ItemStack(BlockUtils.electrum));
		l.add(new ItemStack(BlockUtils.ender));
