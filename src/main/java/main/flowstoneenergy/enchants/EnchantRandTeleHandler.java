...
public class EnchantRandTeleHandler {
    ...
    public void teleport(World world, Entity entity) {
        ...
        if (rand.nextBoolean()) entity.posX += rand.nextDouble() + (rand.nextInt(5 - 0) + 0);
        else entity.posX -= rand.nextDouble() + (rand.nextInt(5 - 0) + 0);
        entity.posY += 40;
        if (rand.nextBoolean()) entity.posZ += rand.nextDouble() + (rand.nextInt(5 - 0) + 0);
        else entity.posZ -= rand.nextDouble() + (rand.nextInt(5 - 0) + 0);
