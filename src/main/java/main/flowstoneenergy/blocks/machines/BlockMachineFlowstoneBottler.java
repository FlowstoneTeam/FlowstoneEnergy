...
public class BlockMachineFlowstoneBottler extends BlockMachineSidedTexure implements IFlowWrenchable {

    private boolean onOff;
    @SuppressWarnings("unused")
    private static boolean canBreak;

    public BlockMachineFlowstoneBottler() {
        this.setHardness(12);
        this.setBlockName(ModInfo.MODID + ".FlowstoneBottler");
    ...
    public void registerBlockIcons(IIconRegister icon) {
        ...
        this.frontOn = icon.registerIcon(ModInfo.MODID + ":machines/flowstoneBottler_Front_Active");
        this.frontOff = icon.registerIcon(ModInfo.MODID + ":machines/flowstoneBottler_Front");
